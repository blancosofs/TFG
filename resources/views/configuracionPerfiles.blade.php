...
<div class="config-hero">
    <div class="config-hero-inner">
        <p class="etiqueta" data-i18n="config.panelUsuario">Panel de usuario</p>
        <h1 data-i18n="config.titulo">Configuración</h1>
        <p data-i18n="config.heroSubtitulo">Personaliza la apariencia de Edunoly según tus preferencias.</p>
    </div>
</div>
    ...
    <div class="config-seccion">
        ...
        <div class="temas-grid" id="temas-grid">
            ...
            <div class="tema-card p-verde" data-tema="verde" onclick="seleccionarTema('verde', this)">
                ...
                <div class="tema-info">
                    <div class="tema-nombre" data-i18n="config.temaVerde">Verde Bosque</div>
                    <div class="tema-desc" data-i18n="config.temaVerdeDesc">Original · Por defecto</div>
                </div>
            </div>
            ...
            <div class="tema-card p-negro" data-tema="negro" onclick="seleccionarTema('negro', this)">
                ...
                <div class="tema-check">✓</div>
                <div class="tema-info">
                    <div class="tema-nombre" data-i18n="config.temaNegro">Noche Profunda</div>
                    <div class="tema-desc" data-i18n="config.temaNegroDesc">Negro · Modo oscuro</div>
                </div>
            </div>
            ...
            <div class="tema-card p-blanco" data-tema="blanco" onclick="seleccionarTema('blanco', this)">
                ...
                <div class="tema-info">
                    <div class="tema-nombre" data-i18n="config.temaBlanco">Blanco Polar</div>
                    <div class="tema-desc" data-i18n="config.temaBlancoDesc">Claro · Modo día</div>
                </div>
            </div>
            ...
            <div class="tema-card p-azul" data-tema="azul" onclick="seleccionarTema('azul', this)">
                ...
                <div class="tema-check">✓</div>
                <div class="tema-info">
                    <div class="tema-nombre" data-i18n="config.temaAzul">Azul Océano</div>
                    <div class="tema-desc" data-i18n="config.temaAzulDesc">Azul · Profesional</div>
                </div>
            </div>
            ...
            <div class="tema-card p-purpura" data-tema="purpura" onclick="seleccionarTema('purpura', this)">
                ...
                <div class="tema-check">✓</div>
                <div class="tema-info">
                    <div class="tema-nombre" data-i18n="config.temaPurpura">Púrpura Crepúsculo</div>
                    <div class="tema-desc" data-i18n="config.temaPurpuraDesc">Violeta · Creativo</div>
                </div>
            </div>
            ...
            <div class="tema-card p-rojo" data-tema="rojo" onclick="seleccionarTema('rojo', this)">
                ...
                <div class="tema-check">✓</div>
                <div class="tema-info">
                    <div class="tema-nombre" data-i18n="config.temaRojo">Rojo Carmín</div>
                    <div class="tema-desc" data-i18n="config.temaRojoDesc">Rojo · Intenso</div>
                </div>
            </div>
    ...
    <div class="config-seccion">
        ...
        <div class="opcion-fila">
            <div class="opcion-info">
                ...
                <div class="opcion-desc" data-i18n="config.animacionesDesc">Desactiva las transiciones y animaciones para reducir el movimiento.</div>
            </div>
            <label class="toggle">
        ...
        <div class="opcion-fila">
            <div class="opcion-info">
                ...
                <div class="opcion-desc" data-i18n="config.fuenteDesc">Ajusta el tamaño del texto en toda la plataforma. El cambio se aplica al guardar.</div>
            </div>
        ...
        <div class="opcion-fila">
            <div class="opcion-info">
                ...
                <div class="opcion-desc" data-i18n="config.contrasteDesc">Aumenta el contraste de textos y bordes para mayor legibilidad.</div>
            </div>
            <label class="toggle">
        ...
        <div class="opcion-fila">
            <div class="opcion-info">
                ...
                <div class="opcion-desc" data-i18n="config.enlacesDesc">Muestra un subrayado en todos los enlaces para identificarlos más fácilmente.</div>
            </div>
            <label class="toggle">
    ...
    <div class="config-seccion">
        ...
        <div class="opcion-fila">
            <div class="opcion-info">
                ...
                <div class="opcion-desc" data-i18n="config.idiomaPlataformaDesc">Cambia el idioma en el que se muestra la interfaz de Edunoly.</div>
            </div>
        ...
        <div class="opcion-fila">
            <div class="opcion-info">
                ...
                <div class="opcion-desc" data-i18n="config.formatoFechaDesc">Elige cómo se muestran las fechas en la plataforma.</div>
            </div>
